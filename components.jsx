...
const PROJECTS = [
  {
    ...
    tone: "tone-c",
    cover: "assets/jenos/17.jpg",
    ph: { es: "Salón principal · Atmósfera gourmet", en: "Main hall · Gourmet atmosphere" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/jenos/02.jpg", label: { es: "Salón principal · Vista general", en: "Main hall · Wide view" } },
      { src: "assets/jenos/01.jpg", label: { es: "Luminaria principal · Doble altura", en: "Pendant cluster · Double-height" } },
      { src: "assets/jenos/04.jpg", label: { es: "Fachada nocturna · Identidad de marca", en: "Evening façade · Brand identity" } },
      { src: "assets/jenos/03.jpg", label: { es: "Acceso · Mirada al interior", en: "Entry · Looking in" } },
      { src: "assets/jenos/05.jpg", label: { es: "Pared firma · Mural de ingredientes", en: "Signature wall · Ingredients mural" } },
      { src: "assets/jenos/15.jpg", label: { es: "Pared firma · Logo Jeno's", en: "Signature wall · Jeno's logo" } },
      { src: "assets/jenos/16.jpg", label: { es: "Vista panorámica · Salón completo", en: "Panoramic · Full hall" } },
      { src: "assets/jenos/08.jpg", label: { es: "Barra · Materialidad piedra y madera", en: "Bar · Stone + wood palette" } },
      { src: "assets/jenos/06.jpg", label: { es: "Bodega de vinos · Detalle", en: "Wine cellar · Detail" } },
      { src: "assets/jenos/19.jpg", label: { es: "Cocina abierta · Barra técnica", en: "Open kitchen · Service counter" } },
      { src: "assets/jenos/20.jpg", label: { es: "Grifo cerveza · Detalle material", en: "Beer tap · Material detail" } },
      { src: "assets/jenos/23.jpg", label: { es: "Barra y cocina · Cierre", en: "Bar and kitchen · Closing view" } },
      { src: "assets/jenos/07.jpg", label: { es: "Plano de techo · Iluminación dirigida", en: "Ceiling plan · Directed lighting" } },
      { src: "assets/jenos/13.jpg", label: { es: "Salón superior · Atmósfera", en: "Upper hall · Atmosphere" } },
      { src: "assets/jenos/11.jpg", label: { es: "Mezzanine · Visión de conjunto", en: "Mezzanine · Overall view" } },
      { src: "assets/jenos/12.jpg", label: { es: "Booths · Confort y privacidad", en: "Booths · Comfort and privacy" } },
      { src: "assets/jenos/14.jpg", label: { es: "Pasillo · Texturas y ritmo", en: "Aisle · Textures and rhythm" } },
      { src: "assets/jenos/09.jpg", label: { es: "Escalera principal · Carpintería", en: "Main stair · Joinery" } },
      { src: "assets/jenos/18.jpg", label: { es: "Escalera · Detalle estructural", en: "Stair · Structural detail" } },
      { src: "assets/jenos/17.jpg", label: { es: "Escalera · Vista vertical", en: "Stair · Vertical view" } },
      { src: "assets/jenos/10.jpg", label: { es: "Doble altura · Lámparas suspendidas", en: "Double-height · Suspended lamps" } },
      { src: "assets/jenos/21.jpg", label: { es: "Luminarias · Plano cenital", en: "Pendants · Overhead view" } },
      { src: "assets/jenos/22.jpg", label: { es: "Acceso lateral · Geometría roja", en: "Side entry · Red geometry" } },
    ],
  },
  {
    id: "beacon-tower",
    ...
    tone: "tone-a",
    cover: "assets/beacon/portada.jpg",
    ph: { es: "Fachada principal · Identidad corporativa", en: "Main façade · Corporate identity" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/beacon/portada.jpg", label: { es: "Fachada principal · Identidad", en: "Main façade · Identity" } },
      { src: "assets/beacon/05.jpg",      label: { es: "Acceso · Escalera y señalética", en: "Entry · Stair and signage" } },
      { src: "assets/beacon/13.jpg",      label: { es: "Lobby · Recepción", en: "Lobby · Reception desk" } },
      { src: "assets/beacon/12.jpg",      label: { es: "Lobby · Pared firma 3D + madera", en: "Lobby · Signature wall + wood" } },
      { src: "assets/beacon/14.jpg",      label: { es: "Recepción · Materialidad piedra", en: "Reception · Stone palette" } },
      { src: "assets/beacon/03.jpg",      label: { es: "Vestíbulo técnico · CCTV", en: "Tech vestibule · CCTV" } },
      { src: "assets/beacon/09.jpg",      label: { es: "Pasillo · Pared escultórica", en: "Corridor · Sculptural wall" } },
      { src: "assets/beacon/07.jpg",      label: { es: "Recepción ejecutiva · Detalle", en: "Executive reception · Detail" } },
      { src: "assets/beacon/01.jpg",      label: { es: "Planta abierta · Iluminación LED", en: "Open floor · LED lighting" } },
      { src: "assets/beacon/06.jpg",      label: { es: "Planta abierta · Pasarela", en: "Open floor · Aisle" } },
      { src: "assets/beacon/10.jpg",      label: { es: "Sala flexible · Visión panorámica", en: "Flex room · Panoramic view" } },
      { src: "assets/beacon/11.jpg",      label: { es: "Espacio amplio · Luz natural", en: "Wide space · Natural light" } },
      { src: "assets/beacon/04.jpg",      label: { es: "Oficina · Vista al exterior", en: "Office · Outside view" } },
      { src: "assets/beacon/08.jpg",      label: { es: "Sala lateral · Madera + vidrio", en: "Side room · Wood + glass" } },
      { src: "assets/beacon/02.jpg",      label: { es: "Pasillo cenital · Estructura", en: "Skylit corridor · Structure" } },
      { src: "assets/beacon/portada.jpg", label: { es: "Cierre · Vista de fachada", en: "Closing · Façade view" } },
    ],
  },
  {
    id: "cafam-empleo",
    ...
    tone: "tone-a",
    cover: "assets/cafam-empleo/portada.jpg",
    ph: { es: "Recepción · Identidad de marca Cafam", en: "Reception · Cafam brand identity" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/cafam-empleo/portada.jpg", label: { es: "Recepción · Identidad de marca", en: "Reception · Brand identity" } },
      { src: "assets/cafam-empleo/04.jpg",      label: { es: "Recepción · Vista general", en: "Reception · Wide view" } },
      { src: "assets/cafam-empleo/07.jpg",      label: { es: "Recepción · Detalle de mostrador", en: "Reception · Counter detail" } },
      { src: "assets/cafam-empleo/02.jpg",      label: { es: "Sala de espera · Cielo raso azul", en: "Waiting area · Blue ceiling" } },
      { src: "assets/cafam-empleo/03.jpg",      label: { es: "Módulos de atención · Vista lateral", en: "Service modules · Side view" } },
      { src: "assets/cafam-empleo/05.jpg",      label: { es: "Módulos · Distribución y señalética", en: "Modules · Layout and signage" } },
      { src: "assets/cafam-empleo/08.jpg",      label: { es: "Aula de orientación · Acceso", en: "Orientation room · Entry" } },
      { src: "assets/cafam-empleo/06.jpg",      label: { es: "Cielo raso · Iluminación indirecta", en: "Ceiling plan · Indirect light" } },
      { src: "assets/cafam-empleo/01.jpg",      label: { es: "Acceso · Vidrio templado y señalética", en: "Entry · Tempered glass and signage" } },
    ],
  },
  {
    id: "edificio-liberty",
    ...
    tone: "tone-a",
    cover: "assets/liberty/portada.png",
    ph: { es: "Fachada principal · Atardecer", en: "Main façade · Sunset" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/liberty/portada.png",            label: { es: "Fachada principal · Atardecer", en: "Main façade · Sunset" } },
      { src: "assets/liberty/02-fachada-contexto.png", label: { es: "Fachada · Contexto urbano", en: "Façade · Urban context" } },
      { src: "assets/liberty/03-planta-3hab.png",     label: { es: "Planta tipo · 3 habitaciones", en: "Floor plan · 3-bedroom unit" } },
      { src: "assets/liberty/04-planta-2hab.png",     label: { es: "Planta tipo · 2 habitaciones", en: "Floor plan · 2-bedroom unit" } },
      { src: "assets/liberty/05-planta-1hab.png",     label: { es: "Planta tipo · 1 habitación", en: "Floor plan · 1-bedroom unit" } },
    ],
  },
  {
    id: "aguas-del-padre",
    ...
    tone: "tone-d",
    cover: "assets/aguas-padre/portada.jpg",
    ph: { es: "Vista panorámica · Casa y piscina en el bosque", en: "Panoramic · House and pool in the woods" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/aguas-padre/portada.jpg", label: { es: "Panorámica · Casa, piscina y bosque", en: "Panoramic · House, pool and forest" } },
      { src: "assets/aguas-padre/03.jpg",      label: { es: "Implantación · Casa entre pinos", en: "Site · House among pines" } },
      { src: "assets/aguas-padre/02.jpg",      label: { es: "Fachada principal · Volumen único", en: "Main façade · Single volume" } },
      { src: "assets/aguas-padre/04.jpg",      label: { es: "Salón principal · Estructura en madera", en: "Main hall · Wood structure" } },
      { src: "assets/aguas-padre/05.jpg",      label: { es: "Salón principal · Cercha de madera y chimenea", en: "Main hall · Timber truss and fireplace" } },
      { src: "assets/aguas-padre/06.png",      label: { es: "Planta de implantación · Casa, piscina y deck", en: "Site plan · House, pool and deck" } },
      { src: "assets/aguas-padre/07.jpg",      label: { es: "Cocina · Mesón en piedra y zona de estudio", en: "Kitchen · Stone counter and study area" } },
    ],
  },
  {
    id: "casa-alvarez",
    ...
    tone: "tone-a",
    cover: "assets/alvarez/portada.png",
    ph: { es: "Fachada principal · Volumen blanco frente al Nevado", en: "Main façade · White volume facing the Nevado" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/alvarez/portada.png", label: { es: "Fachada principal · Volumen blanco", en: "Main façade · White volume" } },
      { src: "assets/alvarez/02.png",      label: { es: "Fachada lateral · Inserción urbana", en: "Side façade · Urban insertion" } },
      { src: "assets/alvarez/03.png",      label: { es: "Salón principal · Madera y mármol", en: "Main living · Wood and marble" } },
      { src: "assets/alvarez/04.png",      label: { es: "Cocina · Isla central y campana", en: "Kitchen · Central island and hood" } },
      { src: "assets/alvarez/05.png",      label: { es: "Comedor · Plafones y luz indirecta", en: "Dining · Coffered ceiling and indirect light" } },
      { src: "assets/alvarez/06.png",      label: { es: "Patio interior · Deck en madera", en: "Inner patio · Wood deck" } },
      { src: "assets/alvarez/07.png",      label: { es: "Estudio · Pared en piedra", en: "Study · Stone wall" } },
    ],
  },
  {
    id: "casa-rivera-rua",
    ...
    tone: "tone-d",
    cover: "assets/cartagena/portada.png",
    ph: { es: "Fachada al atardecer · Persianas de ladrillo y madera", en: "Façade at dusk · Brick and wood louvers" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/cartagena/portada.png", label: { es: "Fachada al atardecer · Persianas de ladrillo y madera", en: "Façade at dusk · Brick and wood louvers" } },
      { src: "assets/cartagena/05.png",      label: { es: "Fachada al espejo de agua · Atardecer", en: "Façade to reflecting pool · Sunset" } },
      { src: "assets/cartagena/06.png",      label: { es: "Fachada · Persianas verticales y luz cálida", en: "Façade · Vertical louvers and warm light" } },
      { src: "assets/cartagena/02.png",      label: { es: "Terraza · Cocina abierta y estar exterior", en: "Terrace · Outdoor kitchen and lounge" } },
      { src: "assets/cartagena/03.png",      label: { es: "Cocina y comedor · Vista al espejo de agua", en: "Kitchen and dining · View to reflecting pool" } },
      { src: "assets/cartagena/04.png",      label: { es: "Baño · Madera, ladrillo y luz rasante", en: "Bathroom · Wood, brick and raking light" } },
    ],
  },
  {
    ...
    tone: "tone-e",
    cover: "assets/tabares/portada.png",
    ph: { es: "Vista aérea nocturna · Casa, piscina y vía láctea", en: "Aerial night view · House, pool and milky way" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/tabares/portada.png", label: { es: "Vista aérea · Casa, piscina y cafetales", en: "Aerial view · House, pool and coffee fields" } },
      { src: "assets/tabares/13.png", label: { es: "Estar principal · Sofá blanco y chimenea", en: "Main living · White sofa and fireplace" } },
      { src: "assets/tabares/10.png", label: { es: "Cocina · Isla en granito y muro en piedra", en: "Kitchen · Granite island and stone wall" } },
      { src: "assets/tabares/01.png", label: { es: "Vista nocturna · Casa bajo la vía láctea", en: "Night view · House under the milky way" } },
      { src: "assets/tabares/11.png", label: { es: "Comedor · Lucernario sobre la mesa", en: "Dining · Skylight over the table" } },
      { src: "assets/tabares/07.png", label: { es: "Fachada posterior · Volumen sobre piedra", en: "Rear façade · Volume over stone" } },
      { src: "assets/tabares/15.png", label: { es: "Piscina · Espejo de agua y mobiliario sumergido", en: "Pool · Reflecting water and sunken lounge" } },
      { src: "assets/tabares/02.png", label: { es: "Terraza · Deck y estar exterior", en: "Terrace · Deck and outdoor lounge" } },
      { src: "assets/tabares/14.png", label: { es: "Estar · Sofá modular y muro en piedra", en: "Living · Modular sofa and stone wall" } },
      { src: "assets/tabares/05.png", label: { es: "Fachada · Iluminación cálida sobre piedra", en: "Façade · Warm light over stone" } },
      { src: "assets/tabares/12.png", label: { es: "Cocina técnica · Isla negra y barra alta", en: "Service kitchen · Black island and high counter" } },
      { src: "assets/tabares/06.png", label: { es: "Vista posterior · Terraza y piscina", en: "Rear view · Terrace and pool" } },
      { src: "assets/tabares/08.png", label: { es: "Terraza posterior · Estar bajo las estrellas", en: "Rear terrace · Lounge under the stars" } },
      { src: "assets/tabares/03.png", label: { es: "Volumen blanco · Deck y mobiliario exterior", en: "White volume · Deck and outdoor seating" } },
      { src: "assets/tabares/16.png", label: { es: "Vista aérea · Casa, deck y piscina infinita", en: "Aerial view · House, deck and infinity pool" } },
    ],
  },
  {
    id: "casa-tamaulipas",
    ...
    tone: "tone-d",
    cover: "assets/tamaulipas/portada.png",
    ph: { es: "Fachada principal · Volumen adobe entre vecinos", en: "Main façade · Adobe volume between neighbors" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/tamaulipas/portada.png", label: { es: "Fachada principal · Volumen adobe en la calle", en: "Main façade · Adobe volume on the street" } },
      { src: "assets/tamaulipas/03.png", label: { es: "Estar y comedor · Escalera y columnas adobe", en: "Living and dining · Stair and adobe columns" } },
      { src: "assets/tamaulipas/02.png", label: { es: "Planta cenital · Sala de juegos y habitaciones", en: "Top-down · Games room and bedrooms" } },
      { src: "assets/tamaulipas/06.png", label: { es: "Pasillo superior · Tapiz mexicano", en: "Upper aisle · Mexican tapestry" } },
      { src: "assets/tamaulipas/04.png", label: { es: "Doble altura · Comedor y barra de cocina", en: "Double height · Dining and kitchen bar" } },
      { src: "assets/tamaulipas/07.png", label: { es: "Fachada posterior · Terrazas y doble altura", en: "Rear façade · Terraces and double height" } },
      { src: "assets/tamaulipas/05.png", label: { es: "Cocina · Isla en granito y barra alta", en: "Kitchen · Granite island and high counter" } },
      { src: "assets/tamaulipas/08.png", label: { es: "Pasillo superior · Mural de Rivera", en: "Upper aisle · Rivera mural" } },
      { src: "assets/tamaulipas/09.png", label: { es: "Interior · Composición de planos adobe", en: "Interior · Adobe plane composition" } },
      { src: "assets/tamaulipas/10.png", label: { es: "Interior · Mobiliario y materialidad", en: "Interior · Furniture and materials" } },
      { src: "assets/tamaulipas/11.png", label: { es: "Interior · Estructura y luz natural", en: "Interior · Structure and natural light" } },
    ],
  },
  {
    id: "apto-graciela",
    ...
    tone: "tone-c",
    cover: "assets/apto-graciela/portada.png",
    ph: { es: "Vista nocturna · Sala y comedor sobre la ciudad", en: "Night view · Living and dining over the city" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/apto-graciela/portada.png", label: { es: "Vista nocturna · Sala y comedor sobre la ciudad", en: "Night view · Living and dining over the city" } },
      { src: "assets/apto-graciela/01.png", label: { es: "Sala · Muros en concreto y arte en color", en: "Living · Concrete walls and color art" } },
      { src: "assets/apto-graciela/02.png", label: { es: "Comedor · Tríptico y ventanal a la ciudad", en: "Dining · Triptych and city window" } },
      { src: "assets/apto-graciela/03.png", label: { es: "Cocina abierta · Madera y barra de apoyo", en: "Open kitchen · Wood and breakfast bar" } },
      { src: "assets/apto-graciela/04.png", label: { es: "Jardín interior · Piedra, agua y vegetación", en: "Inner garden · Stone, water and greenery" } },
    ],
  },
  {
    id: "lede",
    ...
    tone: "tone-e",
    cover: "assets/lede/portada.png",
    ph: { es: "Barra · Atmósfera nocturna", en: "Bar · Evening atmosphere" },
    galleryMode: "scroll",
    gallery: [
      { src: "assets/lede/03.png", label: { es: "Muro luminoso · Acceso a cocina", en: "Light wall · Kitchen access" } },
      { src: "assets/lede/portada.png", label: { es: "Barra · Atmósfera nocturna", en: "Bar · Evening atmosphere" } },
      { src: "assets/lede/05.png", label: { es: "Salón · Repisas iluminadas y barra", en: "Hall · Lit shelving and bar" } },
      { src: "assets/lede/02.png", label: { es: "Plano de techo · Líneas de luz", en: "Ceiling plan · Light lines" } },
      { src: "assets/lede/04.png", label: { es: "Axonometría · Vista de conjunto", en: "Axonometric · Overall view" } },
    ],
  },
  {
    id: "casa-graciela",
    name: { es: "Casa Graciela", en: "Casa Graciela" },
    place: { es: "Bogotá", en: "Bogotá" },
    cat: { es: "Vivienda", en: "Residential" },
    year: "2023",
    role: { es: "Arquitectura · Interiorismo · Dirección de obra", en: "Architecture · Interior · Construction" },
    scope: { es: "320 m² · Reforma integral", en: "320 m² · Full refurb" },
    tone: "tone-d",
    ph: { es: "Interior · Sala principal · Luz natural rasante", en: "Interior · Main living · Raking daylight" },
    gallery: [
      { tone: "tone-c", aspect: "16/10", label: { es: "Sala principal · Vista general", en: "Main living · Wide view" } },
      { tone: "tone-d", aspect: "4/5",   label: { es: "Detalle · Madera maciza", en: "Detail · Solid wood" } },
      { tone: "tone-a", aspect: "4/5",   label: { es: "Cocina · Iluminación dirigida", en: "Kitchen · Directed light" } },
      { tone: "tone-g", aspect: "16/9",  label: { es: "Comedor · Doble altura", en: "Dining · Double-height" } },
      { tone: "tone-f", aspect: "3/4",   label: { es: "Baño principal · Materialidad", en: "Master bath · Materials" } },
    ],
  },
  {
    id: "odr",
    name: { es: "ODR Arquitectura", en: "ODR Arquitectura" },
    place: { es: "Oficina & Showroom", en: "Office & Showroom" },
    cat: { es: "Interiorismo corporativo", en: "Corporate interior" },
    year: "2024",
    role: { es: "Interiorismo · BIM · Dirección", en: "Interior · BIM · Construction" },
    scope: { es: "240 m² · Oficina + showroom", en: "240 m² · Office + showroom" },
    tone: "tone-a",
    ph: { es: "Interior · Showroom · Materialidad madera y piedra", en: "Interior · Showroom · Wood + stone palette" },
    gallery: [
      { tone: "tone-a", aspect: "16/10", label: { es: "Showroom · Vista principal", en: "Showroom · Main view" } },
      { tone: "tone-d", aspect: "4/5",   label: { es: "Oficina · Espacio colaborativo", en: "Office · Collaborative space" } },
      { tone: "tone-g", aspect: "4/5",   label: { es: "Detalle · Carpintería", en: "Detail · Joinery" } },
      { tone: "tone-c", aspect: "16/9",  label: { es: "Sala de juntas · Materialidad", en: "Boardroom · Materials" } },
      { tone: "tone-b", aspect: "3/4",   label: { es: "Acceso · Iluminación natural", en: "Entry · Natural light" } },
    ],
  },
  {
    id: "ampliacion",
    name: { es: "Ampliación Unifamiliar", en: "Single-Family Extension" },
    place: { es: "Cundinamarca", en: "Cundinamarca" },
    cat: { es: "Vivienda", en: "Residential" },
    year: "2021",
    role: { es: "Arquitectura · Dirección de obra", en: "Architecture · Construction" },
    scope: { es: "120 m² · Volumen añadido", en: "120 m² · Added volume" },
    tone: "tone-d",
    ph: { es: "Interior · Doble altura · Volumen añadido", en: "Interior · Double-height · Added volume" },
    gallery: [
      { tone: "tone-d", aspect: "16/10", label: { es: "Doble altura · Vista interior", en: "Double-height · Interior" } },
      { tone: "tone-g", aspect: "4/5",   label: { es: "Estar · Ventanal", en: "Living · Window wall" } },
      { tone: "tone-a", aspect: "4/5",   label: { es: "Escalera · Detalle estructural", en: "Stair · Structural detail" } },
      { tone: "tone-c", aspect: "16/9",  label: { es: "Fachada interior · Patio", en: "Inner façade · Courtyard" } },
    ],
  },
  {
    id: "vanti",
    name: { es: "Vanti — Centro de Operaciones", en: "Vanti — Operations Centre" },
    place: { es: "Bogotá", en: "Bogotá" },
    cat: { es: "Interiorismo técnico", en: "Technical interior" },
    year: "2023",
    role: { es: "Interiorismo técnico · CQC · BIM", en: "Technical interior · CQC · BIM" },
    scope: { es: "450 m² · Sala de control 24/7", en: "450 m² · 24/7 control room" },
    tone: "tone-h",
    ph: { es: "Interior · Sala de control · Iluminación dirigida", en: "Interior · Control room · Directed lighting" },
    gallery: [
      { tone: "tone-h", aspect: "16/10", label: { es: "Sala de control · Vista general", en: "Control room · Wide view" } },
      { tone: "tone-e", aspect: "4/5",   label: { es: "Consolas · Ergonomía", en: "Consoles · Ergonomics" } },
      { tone: "tone-c", aspect: "4/5",   label: { es: "Backwall · Pantallas", en: "Backwall · Video wall" } },
      { tone: "tone-f", aspect: "16/9",  label: { es: "Iluminación dirigida · Detalle", en: "Directed lighting · Detail" } },
      { tone: "tone-h", aspect: "21/9",  label: { es: "Vista panorámica · Operación", en: "Panoramic view · Operations" } },
    ],
  },
  {
    id: "metro-medellin",
    name: { es: "Metro de Medellín", en: "Medellín Metro" },
    place: { es: "Centro de Operaciones", en: "Operations Centre" },
    cat: { es: "Interiorismo institucional", en: "Institutional interior" },
    year: "2022",
    role: { es: "Interiorismo · Coordinación técnica", en: "Interior · Technical coordination" },
    scope: { es: "620 m² · Centro institucional", en: "620 m² · Institutional centre" },
    tone: "tone-f",
    ph: { es: "Interior · Sala de operaciones · Visión panorámica", en: "Interior · Ops floor · Panoramic console" },
    gallery: [
      { tone: "tone-f", aspect: "16/10", label: { es: "Sala de operaciones · Vista", en: "Operations floor · View" } },
      { tone: "tone-c", aspect: "4/5",   label: { es: "Consolas · Mobiliario técnico", en: "Consoles · Technical furniture" } },
      { tone: "tone-h", aspect: "4/5",   label: { es: "Acceso · Identidad institucional", en: "Entry · Institutional identity" } },
      { tone: "tone-a", aspect: "16/9",  label: { es: "Vista panorámica · Backwall", en: "Panoramic · Backwall" } },
      { tone: "tone-e", aspect: "3/4",   label: { es: "Detalle · Iluminación", en: "Detail · Lighting" } },
    ],
  },
  {
    id: "manuelita",
    name: { es: "Ingenio Manuelita", en: "Ingenio Manuelita" },
    place: { es: "Centro de Capacidades", en: "Capabilities Centre" },
    cat: { es: "Interiorismo corporativo", en: "Corporate interior" },
    year: "2024",
    role: { es: "Interiorismo · Diseño técnico", en: "Interior · Technical design" },
    scope: { es: "380 m² · Auditorio + áreas de formación", en: "380 m² · Auditorium + training" },
    tone: "tone-b",
    ph: { es: "Interior · Auditorio · Atmósfera cálida", en: "Interior · Auditorium · Warm atmosphere" },
    gallery: [
      { tone: "tone-b", aspect: "16/10", label: { es: "Auditorio · Vista general", en: "Auditorium · Wide view" } },
      { tone: "tone-d", aspect: "4/5",   label: { es: "Áreas de formación · Detalle", en: "Training areas · Detail" } },
      { tone: "tone-g", aspect: "4/5",   label: { es: "Acceso · Materialidad", en: "Entry · Materials" } },
      { tone: "tone-c", aspect: "16/9",  label: { es: "Sala flexible · Iluminación", en: "Flex room · Lighting" } },
    ],
  },
  {
    id: "cafam",
    name: { es: "Cafam Madelena", en: "Cafam Madelena" },
    place: { es: "Bogotá", en: "Bogotá" },
    cat: { es: "Interiorismo comercial", en: "Commercial interior" },
    year: "2020",
    role: { es: "Interiorismo · Dirección", en: "Interior · Construction" },
    scope: { es: "210 m² · Vestíbulo + circulaciones", en: "210 m² · Lobby + circulation" },
    tone: "tone-g",
    ph: { es: "Interior · Vestíbulo · Composición de planos", en: "Interior · Lobby · Plane composition" },
    gallery: [
      { tone: "tone-g", aspect: "16/10", label: { es: "Vestíbulo · Composición", en: "Lobby · Composition" } },
      { tone: "tone-a", aspect: "4/5",   label: { es: "Circulación · Materialidad", en: "Circulation · Materials" } },
      { tone: "tone-b", aspect: "4/5",   label: { es: "Acceso · Señalética", en: "Entry · Wayfinding" } },
      { tone: "tone-d", aspect: "16/9",  label: { es: "Vista general · Plano abierto", en: "Wide view · Open plan" } },
      { tone: "tone-c", aspect: "1/1",   label: { es: "Detalle · Iluminación", en: "Detail · Lighting" } },
    ],
  },
];
  ...
  return (
    <section className="hero hero--mono wrap" id="top">
      <Reveal className="hero-mono-top">
        <span className="t-eyebrow">{t.hero.eyebrow}</span>
        <span className="hero-mono-place">{t.hero.place}</span>
      </Reveal>
...
function GalleryScroll({ p, lang, t }) {
  ...
  const scrollBy = (dir) => {
    const el = stripRef.current;
    if (!el) return;
    // On touch/narrow layouts each slide is one full viewport → advance by a
    // full width so we land cleanly on the next snap point. On desktop the
    // strip shows multiple images, so advance by ~82%.
    const oneFull = window.matchMedia("(max-width: 900px)").matches;
    const amount = el.clientWidth * (oneFull ? 1 : 0.82);
